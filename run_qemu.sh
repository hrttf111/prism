...
qemu-system-i386 -drive file=data/bios_test1,index=0,media=disk,format=raw -boot c -m 1M -object memory-backend-file,id=pc.ram,size=1M,mem-path=mem.data,prealloc=on,share=on -machine memory-backend=pc.ram
