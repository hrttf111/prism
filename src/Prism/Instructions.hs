...
transferInstrList = [
        ...
        makeInstructionS 0x54 Nothing (decodeStR sp pushOp),
        makeInstructionS 0x55 Nothing (decodeStR bp pushOp),
        ...
        makeInstructionS 0x5C Nothing (decodeStR sp popOp),
        makeInstructionS 0x5D Nothing (decodeStR bp popOp),
...
arithmeticInstrList = [
        ...
        --todo: implement correct decoding of ADD/AAM: rm is always 010 and mod = 000
        makeInstructionS 0xD5 (Just 0x1) (decodeStR2 ax $ instrOF1 aad),
        makeInstructionS 0xD4 (Just 0x1) (decodeStR2 ax $ instrOF1 aam),
