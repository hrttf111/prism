...
logicalInstrList = [
        ...
        --SHL/SAL
        makeInstructionS 0xD0 (Just 4) (decodeN8_ (instrO1 $ rotateFuncOne shl) (instrO1 $ rotateFuncOne shl)),
        makeInstructionS 0xD1 (Just 4) (decodeN16_ (instrO1 $ rotateFuncOne shl) (instrO1 $ rotateFuncOne shl)),
        makeInstructionS 0xD2 (Just 4) (decodeN8_ (instrOV1 $ rotateFuncCl shl) (instrOV1 $ rotateFuncCl shl)),
        makeInstructionS 0xD3 (Just 4) (decodeN16_ (instrOV1 $ rotateFuncCl shl) (instrOV1 $ rotateFuncCl shl)),
        --SHR
        makeInstructionS 0xD0 (Just 5) (decodeN8_ (instrO1 $ rotateFuncOne shr) (instrO1 $ rotateFuncOne shr)),
        makeInstructionS 0xD1 (Just 5) (decodeN16_ (instrO1 $ rotateFuncOne shr) (instrO1 $ rotateFuncOne shr)),
        makeInstructionS 0xD2 (Just 5) (decodeN8_ (instrOV1 $ rotateFuncCl shr) (instrOV1 $ rotateFuncCl shr)),
        makeInstructionS 0xD3 (Just 5) (decodeN16_ (instrOV1 $ rotateFuncCl shr) (instrOV1 $ rotateFuncCl shr)),
        --SAR
        makeInstructionS 0xD0 (Just 7) (decodeN8_ (instrO1 $ rotateFuncOne sar8) (instrO1 $ rotateFuncOne sar8)),
        makeInstructionS 0xD1 (Just 7) (decodeN16_ (instrO1 $ rotateFuncOne sar16) (instrO1 $ rotateFuncOne sar16)),
        makeInstructionS 0xD2 (Just 7) (decodeN8_ (instrOV1 $ rotateFuncCl sar8) (instrOV1 $ rotateFuncCl sar8)),
        makeInstructionS 0xD3 (Just 7) (decodeN16_ (instrOV1 $ rotateFuncCl sar16) (instrOV1 $ rotateFuncCl sar16)),
        --ROL
        makeInstructionS 0xD0 (Just 0) (decodeN8_ (instrO1 $ rotateFuncOne rol) (instrO1 $ rotateFuncOne rol)),
        makeInstructionS 0xD1 (Just 0) (decodeN16_ (instrO1 $ rotateFuncOne rol) (instrO1 $ rotateFuncOne rol)),
        makeInstructionS 0xD2 (Just 0) (decodeN8_ (instrOV1 $ rotateFuncCl rol) (instrOV1 $ rotateFuncCl rol)),
        makeInstructionS 0xD3 (Just 0) (decodeN16_ (instrOV1 $ rotateFuncCl rol) (instrOV1 $ rotateFuncCl rol)),
        --ROR
        makeInstructionS 0xD0 (Just 1) (decodeN8_ (instrO1 $ rotateFuncOne ror) (instrO1 $ rotateFuncOne ror)),
        makeInstructionS 0xD1 (Just 1) (decodeN16_ (instrO1 $ rotateFuncOne ror) (instrO1 $ rotateFuncOne ror)),
        makeInstructionS 0xD2 (Just 1) (decodeN8_ (instrOV1 $ rotateFuncCl ror) (instrOV1 $ rotateFuncCl ror)),
        makeInstructionS 0xD3 (Just 1) (decodeN16_ (instrOV1 $ rotateFuncCl ror) (instrOV1 $ rotateFuncCl ror)),
        --RCL
        makeInstructionS 0xD0 (Just 2) (decodeN8_ (instrO1 $ rotateFuncOne rcl) (instrO1 $ rotateFuncOne rcl)),
        makeInstructionS 0xD1 (Just 2) (decodeN16_ (instrO1 $ rotateFuncOne rcl) (instrO1 $ rotateFuncOne rcl)),
        makeInstructionS 0xD2 (Just 2) (decodeN8_ (instrOV1 $ rotateFuncCl rcl) (instrOV1 $ rotateFuncCl rcl)),
        makeInstructionS 0xD3 (Just 2) (decodeN16_ (instrOV1 $ rotateFuncCl rcl) (instrOV1 $ rotateFuncCl rcl)),
        --RCR
        makeInstructionS 0xD0 (Just 3) (decodeN8_ (instrO1 $ rotateFuncOne rcr) (instrO1 $ rotateFuncOne rcr)),
        makeInstructionS 0xD1 (Just 3) (decodeN16_ (instrO1 $ rotateFuncOne rcr) (instrO1 $ rotateFuncOne rcr)),
        makeInstructionS 0xD2 (Just 3) (decodeN8_ (instrOV1 $ rotateFuncCl rcr) (instrOV1 $ rotateFuncCl rcr)),
        makeInstructionS 0xD3 (Just 3) (decodeN16_ (instrOV1 $ rotateFuncCl rcr) (instrOV1 $ rotateFuncCl rcr)),
        --NOT
        makeInstructionS 0xF6 (Just 2) (decodeN8_ (instrO1 notI) (instrO1 notI)),
        makeInstructionS 0xF7 (Just 2) (decodeN16_ (instrO1 notI) (instrO1 notI))
    ]
